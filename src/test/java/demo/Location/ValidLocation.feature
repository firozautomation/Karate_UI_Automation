...
Scenario: try to login to spa and search for city in location page
  Given driver 'https://webordering-sp-dev.qubeyond.com/362/login'
 # 'https://webordering-sp-stg.qubeyond.com/364/login'
  ...
  And delay(10000)
  Then waitForUrl('https://webordering-sp-dev.qubeyond.com/362/search-locations')
  And delay(10000)
  And input(LocationScreen.Editbox.StreetAddress,Locations.Address.Country)
  And delay(20000)
  When click(LocationScreen.fields.selectedItem)
  And delay(20000)
  When click(LocationScreen.buttons.search)
  And delay(10000)
  And match text(LocationScreen.fields.PugazhStore) contains Locations.Address.Pugazhstore
  And delay(10000)
#   * def foo = { Test : 'text(LocationScreen.fields.PugazhStore)' }
# * def result = true ? karate.match(foo, { Test : 'Locations.Address.Pugazhstore'}) : {}
# * match result == { pass: true, message: null }
# * eval if (result.pass) karate.log('*** Fail')
  When click(LocationScreen.fields.selectedStore)
  And delay(10000)
