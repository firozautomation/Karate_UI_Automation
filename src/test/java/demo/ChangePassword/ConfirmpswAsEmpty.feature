...
@ResponseData
Scenario: In change password page enter old password and new password and make confirm password as empty
  ...
  And delay(20000)
  * def Expected = Validations.Messages.ConfirmfieldMessage
  * def Actual = text(ChangepswrdForm.ErrorMessages.Validations.confirmpassword).trim()
  ...
  # * below('{}Input On Right').click('ChangepswrdForm.Password.SAVEButton')
  # When input(ChangepswrdForm.Password.CurrentPassword,PasswordFormData.FormData.CurrentPassword)
  # And delay(10000)
  # When input(ChangepswrdForm.Password.NewPassword,PasswordFormData.FormData.NewPassword)
  # And delay(10000)
  # When click(ChangepswrdForm.Password.SAVEButton)
  # And delay(10000)
  # And match text(ErrorMessages.Validations.confirmpassword) == Validations.Messages.EmptyFieldMessage
  # And delay(10000)
