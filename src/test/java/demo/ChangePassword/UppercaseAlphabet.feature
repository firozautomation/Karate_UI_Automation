...
@ResponseData
Scenario: In change password page enter old password as valid and Newpassword as notvalid and confirm password same with new password
  ...
  And input(ChangepswrdForm.Password.NewPassword,PasswordFormData.FormData.Invalidpassword)
  And input(ChangepswrdForm.Password.ConfirmPassword,PasswordFormData.FormData.Invalidpassword)
  When click(ChangepswrdForm.Password.SAVEButton)
  And delay(20000)
  * def Expected = Validations.Messages.PopUpMessage
  * def Actual = text(ChangepswrdForm.ErrorMessages.Validations.popup).trim()
  And match Actual == Expected
  * print text(ChangepswrdForm.ErrorMessages.Validations.popup)
  And delay(10000)
  When click(ChangepswrdForm.ErrorMessages.Validations.PopupCloseButton)
  And delay(20000)
