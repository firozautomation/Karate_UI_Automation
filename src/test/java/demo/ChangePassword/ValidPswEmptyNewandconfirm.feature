...
@ResponseData
Scenario: In change password page enter old password as valid and New and confirm password as empty
  ...
  And delay(20000)
  * def Expected = Validations.Messages.NewpasswordfieldMessage
  * def Actual = text(ChangepswrdForm.ErrorMessages.Validations.Newpassword).trim()
