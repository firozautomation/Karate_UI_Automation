...
@ResponseData
Scenario: try to login to spa with Not registered credentials
  ...
  And delay(20000)
  And input(loginScreen.fields.Email,login.Data5.Username)
  And input(loginScreen.fields.password,login.Data5.Password)
