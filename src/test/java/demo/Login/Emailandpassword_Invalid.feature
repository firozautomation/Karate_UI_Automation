...
Scenario: try to login to spa
    with Invalid EmailId and Invalid Password
  ...
  And delay(20000)
  And input(loginScreen.fields.Email,login.Data2.Username)
  And input(loginScreen.fields.password,login.Data2.Password)
